...
public class InventoryGETproductAtrributesTest {
    ...
    public void init() {
        ...
        userService.SendStoreManagerNomination(store.getId(), "itay", "mor", List.of("ADD_PRODUCT", "REMOVE_PRODUCT", "VIEW_PRODUCT", "REMOVE_CATEGORY", "EDIT_PRODUCT"), subscriber.getToken());
        ...
        userService.SendStoreManagerNomination(store2.getId(), "itay", "mor", List.of("ADD_PRODUCT", "REMOVE_PRODUCT", "VIEW_PRODUCT", "REMOVE_CATEGORY", "EDIT_PRODUCT"), subscriber.getToken());
        userService.managerNominationResponse("mor", true, subscriber2.getToken());
    ...
    public void viewProductFromStoreByID(){
        ...
        Assert.assertEquals("ProductINFO{storeID='0', productID=1, name='product1', desc='product1Dec', price=10.0, quantity=30}", response.getData().toString());
    }
