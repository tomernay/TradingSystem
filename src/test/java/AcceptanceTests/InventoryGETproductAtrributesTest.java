...
public class InventoryGETproductAtrributesTest {
    ...
    public void init() {
        ...
        userService.SendStoreManagerNomination(store.getId(), "itay", "mor", List.of("ADD_PRODUCT", "REMOVE_PRODUCT", "REMOVE_CATEGORY", "EDIT_PRODUCT"), subscriber.getToken());
        ...
        userService.SendStoreManagerNomination(store2.getId(), "itay", "mor", List.of("ADD_PRODUCT", "REMOVE_PRODUCT", "REMOVE_CATEGORY", "EDIT_PRODUCT"), subscriber.getToken());
        userService.managerNominationResponse("mor", true, subscriber2.getToken());
