...
public class Store {
    ...
    public Response<String> CreatDiscount(String productID, String category, String percent, String type, String username) {
        Discount discount;
    ...
    public synchronized Response<String> ReleaseShoppSingCart(Map<String, Integer> productsInStore) {
